...
class DeepDarkNight extends Level {
  build(meshes, transparentMeshes) {
    ...
    const nightLinePath = new THREE.ShapePath();
    this.drawRoadLine(this.roadPath, nightLinePath, 0, 0.2, RoadLineStyle.DASH(4, 10), 0, 1, 1);
    this.drawRoadLine(this.roadPath, nightLinePath,-3, 0.15, RoadLineStyle.DASH(30, 2), 0, 1, 500);
    this.drawRoadLine(this.roadPath, nightLinePath, 3, 0.15, RoadLineStyle.DASH(30, 2), 0, 1, 500);
    meshes.push(makeMesh(nightLinePath, 0, 1, roadLineColor));
    const nightPostPath = new THREE.ShapePath();
