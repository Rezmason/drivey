...
class DeepDarkNight extends Level {
  build(meshes, transparentMeshes) {
    ...
    this.drawRoadLine(this.roadPath, linePath, 0, 0.2, RoadLineStyle.DASH(4, 10), 0, 1, 1);
    this.drawRoadLine(this.roadPath, linePath,-3, 0.15, RoadLineStyle.DASH(30, 2), 0, 1, 500);
    this.drawRoadLine(this.roadPath, linePath, 3, 0.15, RoadLineStyle.DASH(30, 2), 0, 1, 500);
    meshes.push(makeMesh(linePath, 0, 1, roadLineColor));
    const postPath = new THREE.ShapePath();
    this.drawRoadLine(this.roadPath, postPath,-6, 0.2, RoadLineStyle.DASH(0.2, 50), 0, 1, 1);
    this.drawRoadLine(this.roadPath, postPath, 6, 0.2, RoadLineStyle.DASH(0.2, 50), 0, 1, 1);
