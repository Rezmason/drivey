...
class Tunnel extends Level {
    ...
    override function build() {
        ...
        drawRoadLine(roadPath, tarmacPath, 0, 7, SOLID, 0, 1, DIVISIONS);
        var tarmacMesh = makeMesh(tarmacPath, 0, 1000, tarmac.getHex());
        world.add(tarmacMesh);

        // do white lines
        var roadLinesPath = new ShapePath();
        drawRoadLine(roadPath, roadLinesPath, -3.5, 0.2, DASH(30, 2), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, roadLinesPath, 3.5, 0.2, DASH(30, 2), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, roadLinesPath, -0.15, 0.15, DASH(4, 8), 0, 1, DIVISIONS);
        ...
        if (true)
        {
            ...
            drawRoadLine(roadPath, crossingPath, 0, 1, DASH(2, 200), 0, 1, DIVISIONS);
            ...
            {
                var width = 6.0 / 6 * 0.5;
                drawRoadLine(roadPath, crossingLinesPath, i * 2 * width - 3 + width, width, DASH(2, 200), 0, 1, DIVISIONS);
            }
        ...
        if (true)
        {
            ...
            drawRoadLine(roadPath, lightsPath, -4, 0.1, DASH(4, 6), 0, 1, DIVISIONS);
            drawRoadLine(roadPath, lightsPath, 4, 0.1, DASH(4, 6), 0, 1, DIVISIONS);
        ...
        if (true)   // walls
        {
            ...
            drawRoadLine(roadPath, wallPath, -5, 0.4, DASH(100, 0), 0, 1, DIVISIONS);
            drawRoadLine(roadPath, wallPath, 5, 0.4, DASH(100, 0), 0, 1, DIVISIONS);
