...
class Tunnel extends Level {
    ...
    override function build() {
        ...
        drawRoadLine(roadPath, tunnelTarmacPath, 0, 7, DASH(30, 0), 0, 1, DIVISIONS);
        ...
        // do yellow lines
        var tunnelYellowLinesPath = new ShapePath();
        drawRoadLine(roadPath, tunnelYellowLinesPath, 0.125, 0.125, DASH(30, 0), 0, 1, DIVISIONS);
        var tunnelYellowLinesMesh = makeMesh(tunnelYellowLinesPath, 0, 1000, yellowLines);
        world.add(tunnelYellowLinesMesh);
        ...
        if (true)
        {
            ...
            tunnelCrossingPath = expandShapePath(tunnelCrossingPath, 1, DIVISIONS);
