...
class IndustrialZone extends Level {
    ...
    override function build() {
        ...
        var industrialTallThingBMesh = makeMesh(industrialTallThingBPath, 60, 10, ground);
        ...
        var industrialMediumThingsMesh = makeMesh(industrialMediumThingsPath, 12, 10, ground);
        ...
        var industrialCrossingMesh = makeMesh(industrialCrossingPath, 0, 10, ground);
        ...
        var industrialStreetLight1Mesh = makeMesh(industrialStreetLight1Path, thick, 10, ground);
        ...
        var industrialStreetLight2Mesh = makeMesh(industrialStreetLight2Path, tall + thick, 10, ground);
        ...
        var industrialOverpassAMesh = makeMesh(industrialOverpassAPath, 2, 10, ground);
        ...
        var industrialOverpassBMesh = makeMesh(industrialOverpassBPath, 10, 10, ground);
        ...
        var industrialPolesMesh = makeMesh(industrialPolesPath, 12, 10, ground);
        ...
        var industrialKnobsMesh = makeMesh(industrialKnobsPath, 1, 10, ground);
        ...
        var industrialWiresMesh = makeMesh(industrialWiresPath, wireThickness, 10, ground);
        ...
        drawRoadLine(roadPath, industrialFenceAPath, dist, 0.1, DOT(spacing), 0, 1, 1);
        var industrialFenceAMesh = makeMesh(industrialFenceAPath, tall, 10, ground);
        ...
        drawRoadLine(roadPath, industrialFenceBPath, dist, 0.1, DASH(spacing, 0), 0, 1, 1);
        var industrialFenceBMesh = makeMesh(industrialFenceBPath, 0.1, 10, ground);
        ...
        drawRoadLine(roadPath, industrialFenceCPath, dist, 0.1, DASH(spacing, 0), 0, 1, 1);
        var industrialFenceCMesh = makeMesh(industrialFenceCPath, tall - 0.5, 10, ground, 0.25);
        meshes.push(industrialFenceCMesh);
    }
}
