...
class IndustrialZone extends Level {
    ...
    override function build() {
        ...
        drawRoadLine(roadPath, industrialTallThingAPath, 300, 0.5, DOT(250), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialTallThingAPath, 320, 0.75, DOT(250), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialTallThingBPath, 300, 0.5, DOT(250), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialTallThingBPath, 320, 0.75, DOT(250), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialTallThingBPath, 400, 8, DOT(240), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialTallThingBPath, 500, 8, DOT(240), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialMediumThingsPath, -80, 20, DASH(40, 60), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialMediumThingsPath, 180, 50, DASH(40, 30), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialMediumThingsPath, 300, 50, DASH(20, 20), 0, 1, DIVISIONS);

        drawRoadLine(roadPath, industrialMediumThingsPath, -100, 8, DOT(200), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialMediumThingsPath, -60, 8, DOT(1500), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialMediumThingsPath, 100, 8, DOT(140), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialMediumThingsPath, 120, 8, DOT(220), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialWhiteLinesPath, -3.5, 0.15, DASH(60, 2), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWhiteLinesPath, 3.5, 0.15, DASH(60, 2), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWhiteLinesPath, -0.15, 0.125, DASH(4, 6), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWhiteLinesPath, 0.125, 0.125, DASH(60, 0), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialCrossingPath, 0, 1, DASH(2, 200), 0, 1, DIVISIONS);
        ...
        {
            var width = 6.0 / 6 * 0.5;
            drawRoadLine(roadPath, industrialCrossingLinesPath, i * 2 * width - 3 + width, width, DASH(2, 200), 0, 1, DIVISIONS);
        }
        ...
        drawRoadLine(roadPath, industrialStreetLight1Path, -5.6, 5, DASH(thick, left), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialStreetLight2Path, -8, thick, DASH(thick, left), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialStreetLight3Path, -4, 2, DASH(thick, left), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialPolesPath, -30, 0.25, DOT(90), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, -40, 0.25, DOT(110), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, 60, 0.25, DOT(60), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, -50, 0.25, DOT(60), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, -20, 0.125, DOT(100), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, 20, 0.25, DOT(45), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, 50, 0.125, DOT(50), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialPolesPath, 70, 0.25, DOT(75), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialKnobsPath, -40, 1, DOT(110), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialKnobsPath, 60, 1, DOT(60), 0, 1, DIVISIONS);
        ...
        // wires
        var wireThickness = 0.05; // 0.025;
        var industrialWiresPath = new ShapePath();
        drawRoadLine(roadPath, industrialWiresPath, -50, wireThickness, DASH(60, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWiresPath, -20, wireThickness, DASH(100, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWiresPath, 20, wireThickness, DASH(45, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWiresPath, 50, wireThickness, DASH(50, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialWiresPath, 70, wireThickness, DASH(75, 0), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialFenceAPath, -dist, 0.1, DOT(spacing), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialFenceAPath, dist, 0.1, DOT(spacing), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialFenceBPath, -dist, 0.1, DASH(spacing, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialFenceBPath, dist, 0.1, DASH(spacing, 0), 0, 1, DIVISIONS);
        ...
        drawRoadLine(roadPath, industrialFenceCPath, -dist, 0.1, DASH(spacing, 0), 0, 1, DIVISIONS);
        drawRoadLine(roadPath, industrialFenceCPath, dist, 0.1, DASH(spacing, 0), 0, 1, DIVISIONS);
