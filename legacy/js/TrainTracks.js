...
class TrainTracks extends Level {
  build(meshes, transparentMeshes, skyMeshes) {
    ...
    this.drawRoadLine(this.roadPath, ballast,  2.5, 2.5, RoadLineStyle.SOLID(5), 0, 1);
    const ballastMesh = makeMesh(ballast, 0, 1, ballastColor, 1);
    ...
    const lightFeaturesMesh = makeMesh(lightFeatures, 0, 12, this.ground + 0.1, 1);
    ...
    meshes.push(makeMesh(darkFeatures, 0, 12, this.ground - 0.2, 1));
  }
}
